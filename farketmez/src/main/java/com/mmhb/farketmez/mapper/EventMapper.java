...
public class EventMapper {
	...
	public static Event fromEventDto(EventDTO eventDto) {
		return new Event(eventDto.getId(), eventDto.getEventType(), eventDto.getLocation(), eventDto.getCreatorId(),
				eventDto.getIsActive(), eventDto.getIsPrivate(), eventDto.getTitle(), eventDto.getCost(), eventDto.getPlace(), eventDto.getDescription(),
				eventDto.getDate(), eventDto.getAverageRating());
	}
}
