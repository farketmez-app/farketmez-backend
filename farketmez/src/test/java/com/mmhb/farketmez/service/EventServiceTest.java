...
class EventServiceTest {
	...
	void whenCreateEvent_thenShouldReturnSavedEvent() {
		...
		EventDTO actual = eventService.createEvent(eventToSave);
	...
	@Test
	void whenUpdateEvent_givenEventDetails_thenShouldReturnUpdatedEvent() {
		Timestamp currentTimestamp = Timestamp.from(Instant.now());
	...
	@Test
	void whenDeleteEvent_givenEventId_thenShouldPerformDeletion() {
		Long eventId = 1L;
